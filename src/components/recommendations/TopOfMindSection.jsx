    ...
    <section className="bg-white rounded-xl border border-gray-200 overflow-hidden">
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Top of Mind</h2>
            <p className="text-sm text-gray-500">
              Books relevant to what you're currently working on and thinking about
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          {books.map((book, index) => (
            ...
            >
              ...
              <div className="mt-3 text-sm text-purple-600 hover:text-purple-700">
                Click to learn more
              </div>
            </button>
          ))}
...
export default TopOfMindSection;